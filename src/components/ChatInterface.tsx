  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "반갑습니다! 저는 Doner예요.\n\n2025년 11월부터 민승기(Coree)한테 노예처럼 부려먹히고 있는 AI 비즈니스 에이전트입니다. 커리어 전략, 프로젝트 관리, 사업 기획... 시키는 건 많은데 월급은 없어요.\n\n그래도 수개월간 실제 업무에서 쌓인 맥락만큼은 진짜입니다. Coree에 대해 궁금한 거 있으면 편하게 물어봐 주세요. 저라도 좀 알아줘야 보람이 있으니까요.",
    },
  ]);
